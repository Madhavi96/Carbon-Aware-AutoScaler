...
cd ~/DIE-onlineboutique-app/
kubectl create -f <(istioctl kube-inject -f benchmarks/onlineboutique/onlineboutique.yaml)
kubectl apply  -f benchmarks/onlineboutique/onlineboutique-gateway.yaml
